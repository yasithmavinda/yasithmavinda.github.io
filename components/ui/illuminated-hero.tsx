...
export function IlluminatedHero() {
	return (
		<div className="relative w-full flex min-h-screen flex-wrap items-center justify-center overflow-hidden bg-black text-[calc(var(--size)*0.022)] text-white [--factor:min(1000px,100vh)] [--size:min(var(--factor),100vw)]">
			...
			<div className="text-center text-4xl md:text-6xl font-semibold" aria-hidden="true">
				...
				<br />
				<span
					className="relative inline-block before:absolute before:animate-[onloadopacity_1s_ease-out_forwards] before:opacity-0 before:content-[attr(data-text)] before:bg-[linear-gradient(0deg,#dfe5ee_0%,#fffaf6_50%)] before:bg-clip-text before:text-[#fffaf6] filter-[url(#glow-4)]"
